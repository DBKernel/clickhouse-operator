...
import (
	...
	"github.com/DBKernel/clickhouse-operator/pkg/apis/clickhouse.dbkernel.com"
...
const (
	// Kubernetes labels
	LabelReadyName                    = clickhousedbkernelcom.GroupName + "/ready"
	LabelReadyValue                   = "yes"
	LabelAppName                      = clickhousedbkernelcom.GroupName + "/app"
	LabelAppValue                     = "chop"
	LabelCHOP                         = clickhousedbkernelcom.GroupName + "/chop"
	LabelNamespace                    = clickhousedbkernelcom.GroupName + "/namespace"
	LabelCHIName                      = clickhousedbkernelcom.GroupName + "/chi"
	LabelClusterName                  = clickhousedbkernelcom.GroupName + "/cluster"
	LabelShardName                    = clickhousedbkernelcom.GroupName + "/shard"
	LabelReplicaName                  = clickhousedbkernelcom.GroupName + "/replica"
	LabelConfigMap                    = clickhousedbkernelcom.GroupName + "/ConfigMap"
	labelConfigMapValueCHICommon      = "ChiCommon"
	labelConfigMapValueCHICommonUsers = "ChiCommonUsers"
	labelConfigMapValueHost           = "Host"
	LabelService                      = clickhousedbkernelcom.GroupName + "/Service"
	labelServiceValueCHI              = "chi"
	labelServiceValueCluster          = "cluster"
	labelServiceValueShard            = "shard"
	labelServiceValueHost             = "host"
	LabelPVCReclaimPolicyName         = clickhousedbkernelcom.GroupName + "/reclaimPolicy"

	// Supplementary service labels - used to cooperate with k8s
	LabelZookeeperConfigVersion = clickhousedbkernelcom.GroupName + "/zookeeper-version"
	LabelSettingsConfigVersion  = clickhousedbkernelcom.GroupName + "/settings-version"
	LabelObjectVersion          = clickhousedbkernelcom.GroupName + "/object-version"

	// Optional labels
	LabelShardScopeIndex         = clickhousedbkernelcom.GroupName + "/shardScopeIndex"
	LabelReplicaScopeIndex       = clickhousedbkernelcom.GroupName + "/replicaScopeIndex"
	LabelCHIScopeIndex           = clickhousedbkernelcom.GroupName + "/chiScopeIndex"
	LabelCHIScopeCycleSize       = clickhousedbkernelcom.GroupName + "/chiScopeCycleSize"
	LabelCHIScopeCycleIndex      = clickhousedbkernelcom.GroupName + "/chiScopeCycleIndex"
	LabelCHIScopeCycleOffset     = clickhousedbkernelcom.GroupName + "/chiScopeCycleOffset"
	LabelClusterScopeIndex       = clickhousedbkernelcom.GroupName + "/clusterScopeIndex"
	LabelClusterScopeCycleSize   = clickhousedbkernelcom.GroupName + "/clusterScopeCycleSize"
	LabelClusterScopeCycleIndex  = clickhousedbkernelcom.GroupName + "/clusterScopeCycleIndex"
	LabelClusterScopeCycleOffset = clickhousedbkernelcom.GroupName + "/clusterScopeCycleOffset"
)
